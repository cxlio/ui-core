...
:host([iconalign=end]) { padding-inline-start: 16px; }
:host([iconalign=end]) .icon { inset-inline-start: auto; inset-inline-end: 12px; rotate: -90deg; }
